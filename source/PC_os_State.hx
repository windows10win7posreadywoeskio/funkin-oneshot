...
class DesktopState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		DiscordClient.changePresence("Motherfucking", null);
		#end
		
		super.create();

		FlxG.save.bind('funkin', 'oneshot');
		...
		bg = new FlxSprite(0, 0).loadGraphic(Paths.image('WUH'));
	...
	var sprite:FlxSprite;
		...
		var sprite2:FlxSprite = new FlxSprite().loadGraphic(Paths.image('pc/thatLogo'), false, 0, 0, true);
		var sprite3:FlxSprite = new FlxSprite().loadGraphic(Paths.image('pc/Settongs'), false, 0, 0, true);
		var sprite4:FlxSprite = new FlxSprite().loadGraphic(Paths.image('pc/ost'), false, 0, 0, true);
