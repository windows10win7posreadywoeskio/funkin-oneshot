...
class PlayState extends MusicBeatState
{
	...
	public var altUnspawnNotes:Array<Note> = [];
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'screwruption':
				credits = 'Screw you. You\'re done. Go home. - Song made by The Pizza Tower Fan';

			case 'opposition':
				credits = 'Fuck you. Screw you. You\'re done forever. - Song made by Maevings';
		}
		...
		switch(randomThingy)
	    {
			case 0:
				...
				{
					case 'opposition':
						engineName = 'Niko\'s a bitchass motherfucker. | Niko ';
					default:
						engineName = 'Niko ';
				}
		}
		...
		kadeEngineWatermark = new FlxText(4, textYPos, 0,
			SONG.song
			+ " - " + engineName + "Engine (Psych Engine 0.5.1)", 16);
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingName == '?') {
			scoreTxt.text = 'Score: ' + songScore + ' | Misses: ' + songMisses + ' | Rating: ' + ratingName + ' | Le combo: ' + Std.string(combo);
		} else {
			scoreTxt.text = 'Score: ' + songScore + ' | Misses: ' + songMisses + ' | Rating: ' + ratingName + ' (' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%)' + ' - ' + ratingFC + ' | Le combo: ' + Std.string(combo);//peeps wanted no integer rating
		}
	...
	public function endSong():Void
	{
		...
		if (Paths.formatToSongPath(curSong) == 'opposition') {
